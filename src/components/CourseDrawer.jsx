...
// Code-split Chart.js: it only renders inside the open drawer, so keep it out of
// the main bundle and load it on demand when a cell is clicked.
        ...
        {loading ? <p className="text-muted font-mono text-sm">Loading…</p> : error ? (
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Suspense fallback={<p className="text-muted text-xs font-mono">Loading chart…</p>}>
